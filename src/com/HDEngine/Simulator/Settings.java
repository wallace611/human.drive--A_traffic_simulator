...
public class Settings {
    ...
    public static World getDemoWorld1() {
        ...
        rc210.setImagePath("src/com/HDEngine/Simulator/image/testimg.png");
        ...
        rc15.setImagePath("src/com/HDEngine/Simulator/image/testimg.png");
        world.addRoadChunk(1, 5, rc15);

        RoadChunk rc45 = new RoadChunk((byte) 1, new RoadChunk[]{rc35}, new float[]{1.0f});
        rc45.setImagePath("src/com/HDEngine/Simulator/image/testimg.png");
        ...
        rc55.setImagePath("src/com/HDEngine/Simulator/image/testimg.png");
